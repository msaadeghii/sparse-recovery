function [x,er,iter]=ISP_SL0(A, y, c, maxiter, Tf, L, A_pinv, xo,sigC,w,eps,gamma,noise_mode,rob_mode, mu_0)
...
if noise_mode==0
    ...
    while iter <= maxiter || thr>=Tf  %thr > tol
        ...
        for l=1:L
            ...
            delta = OurDelta(yk,thr);            % Thresholding
            x = yk - mu_0*delta;
